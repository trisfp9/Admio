// Canonical public origin. Used for metadataBase, canonical URLs, robots and
// the sitemap. Deployment URLs (*.vercel.app) must never end up here or Google
// will index preview builds alongside production.
export const SITE_URL = "https://admio.io";
